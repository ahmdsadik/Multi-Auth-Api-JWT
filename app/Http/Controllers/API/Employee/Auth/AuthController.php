...
class AuthController extends Controller
{
    ...
    {
        $this->middleware('Api-Auth:employee-api', ['except' => ['login', 'register']]);
    }
    ...
    public function register(Request $request)
    {
        ...
        $token = auth('employee-api')->login($user);
    ...
    {
        return $this->successResponse(auth('employee-api')->user());
    }
    ...
    {
        return $this->successResponse($this->respondWithToken(auth('employee-api')->refresh()));
    }
