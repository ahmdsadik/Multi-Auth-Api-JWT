...
class AuthController extends Controller
{
    ...
    {
        $this->middleware('Api-Auth:admin-api', ['except' => ['login', 'register']]);
    }
    ...
    {
        return $this->successResponse(auth('admin-api')->user());
    }
    ...
    {
        return $this->successResponse($this->respondWithToken(auth('admin-api')->refresh()));
    }
